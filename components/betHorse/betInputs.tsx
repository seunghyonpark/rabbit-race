...
import NPC from '@/libs/enums/npc.enums';
        ...
        <>
            <div className='flex flex-col items-center justify-center gap-5 w-full lg:w-2/3 '>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center w-full md:justify-around gap-3'>
                    <button onClick={() => { setSecilenAt(NPC.Horse1) }}
                        className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse1 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                    >{NPC.Horse1} x{horse1} </button>
                    <button onClick={() => { setSecilenAt(NPC.Horse2) }}
                        className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse2 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                    >{NPC.Horse2} x{horse2}</button>

                    <div className="space-x-10 md:hidden">
                        <button onClick={() => { setSecilenAt(NPC.Horse1) }}
                            className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse1 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                        >{NPC.Horse1} x{horse1} </button>
                        <button onClick={() => { setSecilenAt(NPC.Horse2) }}
                            className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse2 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                        >{NPC.Horse2} x{horse2}</button>
                    </div>

                    <button onClick={() => { setSecilenAt(NPC.Horse3) }}
                        className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse3 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                    >{NPC.Horse3} x{horse3}</button>
                    <button onClick={() => { setSecilenAt(NPC.Horse4) }}
                        className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse4 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                    >{NPC.Horse4} x{horse4}</button>
                    <div className="space-x-10 md:hidden">
                        <button onClick={() => { setSecilenAt(NPC.Horse3) }}
                            className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse3 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                        >{NPC.Horse3} x{horse3}</button>
                        <button onClick={() => { setSecilenAt(NPC.Horse4) }}
                            className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse4 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                        >{NPC.Horse4} x{horse4}</button>
                    </div>
                    <button onClick={() => { setSecilenAt(NPC.Horse5) }}
                        className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${secilenAt === NPC.Horse5 ? "bg=[#333541]" : secilenAt === 0 ? "bg=[#333541]" : "btn-ghost"}`}
                    >{NPC.Horse5} x{horse5}</button>
